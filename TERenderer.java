...
public class TERenderer {
    ...
    public void renderFrame(TETile[][] world) {
        ...
        //StdDraw.rectangle(world.length - 30, world[0].length - 1,2, 0.7);
        StdDraw.text(world.length - 30, world[0].length - 1, "UP(W)     " + "Left(A)     "+ "Down(S)     "
                + "Right(R)     " + "Save/Quit (:Q)     "  + "Light-Effect(E)     " + "Change-Avatar(C)");
        StdDraw.show();
    }
}
